...
const COPY = {
  en: {
    ...
    raw: '“New operational request detected across connected channels.”',
    outcome: 'Request routed · execution complete · systems synchronized',
    steps: [
      'Signal capture',
      'Intent analysis',
      'Decision routing',
  ...
  ar: {
    ...
    live: 'النظام يعمل',
    automated: 'مُنسّقة',
    raw: '«تم رصد طلب تشغيلي جديد عبر القنوات المتصلة.»',
    outcome: 'تم توجيه الطلب · اكتمل التنفيذ · تزامنت الأنظمة',
    steps: [
      'التقاط الإشارة',
      'تحليل النية',
      'توجيه القرار',
